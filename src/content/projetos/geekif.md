...
O GEEK IF é um projeto que foi demandado um site para divulgar o evento conhecido como "GEEK IF" do Câmpus de Itapetininga do Instituto Federal de São Paulo, construindo diversas páginas para o site como: Página Inicial, Páginas das Atrações, Página de Galeria e diversas outras. Utilizando-se das tecnologias de AJAX e de uma API disponibilizada pelo Google Maps, o site é construído com HTML, CSS e JavaScript.
